...
Angriffe, welche diese ausnutzen auf den gesammten Server mit allen 
Verbindungen aus, da alle Sitzungen in nur einem Addressraum ablaufen.
Durch eine Aufteilung in unterschiedliche Addressräume durch \texttt{fork()}, 
wie es in vielen Mailservern praktiziert wird, kännte man dieses Problem lösen.
Zudem umgeht man damit das Problem der Verzögerung aller Verbindungen wenn eine
durch warten auf einen Timeout blokiert ist.
...
beherrscht. Es gelten jedoch einige Aufgabenbedignte Einschränkungen, welche
